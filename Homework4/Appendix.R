...
# Introduction
# In this homework, I will explore, analyze and model a data set containing approximately 8000 records representing a customer at an auto insurance company.
...
# taht the person was not in a car crash. The second response variable is TARGET_AMT. This value is zero if the person did not crash their car. But
# if they did crash their car, this number will be a value greater than zero. 
